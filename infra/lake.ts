...
const tableBucketName = `ircoder-${$app.stage}-lake`
...
const firehose = new aws.kinesis.FirehoseDeliveryStream(
  "LakeFirehose",
  {
    name: `ircoder-${$app.stage}-lake-ingest`,
    destination: "iceberg",
