...
npm i -g ircoder-ai@latest        # o bun/pnpm/yarn
scoop install ircoder             # Windows
choco install ircoder             # Windows
brew install anomalyco/tap/ircoder # macOS y Linux (recomendado, siempre al día)
brew install ircoder              # macOS y Linux (fórmula oficial de brew, se actualiza menos)
sudo pacman -S ircoder            # Arch Linux (Stable)
paru -S ircoder-bin               # Arch Linux (Latest from AUR)
mise use -g ircoder               # cualquier sistema
nix run nixpkgs#ircoder           # o github:anomalyco/ircoder para la rama dev más reciente
```
...
IRcoder también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/anomalyco/ircoder/releases) o desde [ircoder.ai/download](https://ircoder.ai/download).
...
1. `$IRCODER_INSTALL_DIR` - Directorio de instalación personalizado
2. `$XDG_BIN_DIR` - Ruta compatible con la especificación XDG Base Directory
3. `$HOME/bin` - Directorio binario estándar del usuario (si existe o se puede crear)
4. `$HOME/.ircoder/bin` - Alternativa por defecto
...
IRcoder incluye dos agentes integrados que puedes alternar con la tecla `Tab`.
...
Más información sobre [agentes](https://ircoder.ai/docs/agents).

### Documentación

Para más información sobre cómo configurar IRcoder, [**ve a nuestra documentación**](https://ircoder.ai/docs).

### Contribuir

Si te interesa contribuir a IRcoder, lee nuestras [docs de contribución](./CONTRIBUTING.md) antes de enviar un pull request.

### Proyectos basados en IRcoder

Si estás trabajando en un proyecto basado en IRcoder y usas "ircoder" como parte del nombre, por ejemplo, "ircoder-dashboard" u "ircoder-mobile", agrega una nota en tu README para aclarar que no está hecho por el equipo de IRcoder y que no está afiliado con nosotros de ninguna manera.

---

**Únete a nuestra comunidad** [Discord](https://discord.gg/ircoder) | [X.com](https://x.com/ircoder)
