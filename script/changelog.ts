...
Generates UPCOMING_CHANGELOG.md by running the ircoder changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for ircoder run (default: low)
      --quiet            Suppress ircoder command output unless it fails
