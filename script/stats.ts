...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/ircoder/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/ircoder...\n")
...
console.log("Fetching npm all-time downloads for ircoder-ai...\n")
const npmDownloads = await fetchNpmDownloads("ircoder-ai")
