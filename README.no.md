...
brew install anomalyco/tap/ircoder # macOS og Linux (anbefalt, alltid oppdatert)
brew install ircoder              # macOS og Linux (offisiell brew-formel, oppdateres sjeldnere)
...
IRcoder er også tilgjengelig som en desktop-app. Last ned direkte fra [releases-siden](https://github.com/anomalyco/ircoder/releases) eller [ircoder.ai/download](https://ircoder.ai/download).
...
1. `$IRCODER_INSTALL_DIR` - Egendefinert installasjonsmappe
...
IRcoder har to innebygde agents du kan bytte mellom med `Tab`-tasten.
...
Les mer om [agents](https://ircoder.ai/docs/agents).

### Dokumentasjon

For mer info om hvordan du konfigurerer IRcoder, [**se dokumentasjonen**](https://ircoder.ai/docs).

### Bidra

Hvis du vil bidra til IRcoder, les [contributing docs](./CONTRIBUTING.md) før du sender en pull request.

### Bygge på IRcoder

Hvis du jobber med et prosjekt som er relatert til IRcoder og bruker "ircoder" som en del av navnet; for eksempel "ircoder-dashboard" eller "ircoder-mobile", legg inn en merknad i README som presiserer at det ikke er bygget av IRcoder-teamet og ikke er tilknyttet oss på noen måte.

---

**Bli med i fellesskapet** [Discord](https://discord.gg/ircoder) | [X.com](https://x.com/ircoder)
