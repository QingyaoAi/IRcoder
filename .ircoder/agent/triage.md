...
Desktop application and browser-based app issues, including `ircoder web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core ircoder server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

IRcoder Zen, IRcoder Go, and billing issues.
