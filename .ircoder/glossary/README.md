...
Use this folder for locale-specific translation guidance that supplements `.ircoder/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/ircoder/pull/12345

## Do Not Translate (Locale Additions)

- `IRcoder` (preserve casing)
