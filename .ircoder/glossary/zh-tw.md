...
- PR #13942: https://github.com/anomalyco/ircoder/pull/13942

## Do Not Translate (Locale Additions)

- `IRcoder` (preserve casing in prose; keep `ircoder` only when it is part of commands, package names, paths, or code)
- `IRcoder Zen`
- `IRcoder CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `ircoder` in prose when referring to the product name; use `IRcoder`
