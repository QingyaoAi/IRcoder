...
- PR #10018: https://github.com/anomalyco/ircoder/pull/10018
- PR #12935: https://github.com/anomalyco/ircoder/pull/12935

## Do Not Translate (Locale Additions)

- `IRcoder` (preserve casing in prose; keep `ircoder` only in commands, package names, paths, or code)
- `IRcoder CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
