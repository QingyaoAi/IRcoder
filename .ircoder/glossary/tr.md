...
- PR #15835: https://github.com/anomalyco/ircoder/pull/15835

## Do Not Translate (Locale Additions)

- `IRcoder` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `ircoder` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `IRcoder` in prose, `ircoder` only for exact technical identifiers
...
- Avoid changing `ircoder` to `IRcoder` inside commands, URLs, package names, or code literals
