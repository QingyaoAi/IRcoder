...
# Package managers
npm i -g ircoder-ai@latest        # or bun/pnpm/yarn
scoop install ircoder             # Windows
choco install ircoder             # Windows
brew install anomalyco/tap/ircoder # macOS and Linux (recommended, always up to date)
brew install ircoder              # macOS and Linux (official brew formula, updated less)
sudo pacman -S ircoder            # Arch Linux (Stable)
paru -S ircoder-bin               # Arch Linux (Latest from AUR)
mise use -g ircoder               # Any OS
nix run nixpkgs#ircoder           # or github:anomalyco/ircoder for latest dev branch
```
...
IRcoder ডেস্কটপ অ্যাপ্লিকেশন হিসেবেও উপলব্ধ। সরাসরি [রিলিজ পেজ](https://github.com/anomalyco/ircoder/releases) অথবা [ircoder.ai/download](https://ircoder.ai/download) থেকে ডাউনলোড করুন।
...
1. `$IRCODER_INSTALL_DIR` - কাস্টম ইনস্টলেশন ডিরেক্টরি
...
4. `$HOME/.ircoder/bin` - ডিফল্ট ফলব্যাক
...
IRcoder এ দুটি বিল্ট-ইন এজেন্ট রয়েছে যা আপনি `Tab` কি(key) দিয়ে পরিবর্তন করতে পারবেন।
...
এজেন্টদের সম্পর্কে আরও জানুন: [docs](https://ircoder.ai/docs/agents)।

### ডকুমেন্টেশন (Documentation)

কিভাবে IRcoder কনফিগার করবেন সে সম্পর্কে আরও তথ্যের জন্য, [**আমাদের ডকস দেখুন**](https://ircoder.ai/docs)।

### অবদান (Contributing)

আপনি যদি IRcoder এ অবদান রাখতে চান, অনুগ্রহ করে একটি পুল রিকোয়েস্ট সাবমিট করার আগে আমাদের [কন্ট্রিবিউটিং ডকস](./CONTRIBUTING.md) পড়ে নিন।

### IRcoder এর উপর বিল্ডিং (Building on IRcoder)

আপনি যদি এমন প্রজেক্টে কাজ করেন যা IRcoder এর সাথে সম্পর্কিত এবং প্রজেক্টের নামের অংশ হিসেবে "ircoder" ব্যবহার করেন, উদাহরণস্বরূপ "ircoder-dashboard" বা "ircoder-mobile", তবে দয়া করে আপনার README তে একটি নোট যোগ করে স্পষ্ট করুন যে এই প্রজেক্টটি IRcoder দল দ্বারা তৈরি হয়নি এবং আমাদের সাথে এর কোনো সরাসরি সম্পর্ক নেই।

---

**আমাদের কমিউনিটিতে যুক্ত হোন** [Discord](https://discord.gg/ircoder) | [X.com](https://x.com/ircoder)
