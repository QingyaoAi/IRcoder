...
import desktopAppIcon from "../../asset/lander/ircoder-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://ircoder.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>ircoder.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g ircoder-ai")}>
                <code>
                  npm i -g <strong>ircoder-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g ircoder-ai")}>
                <code>
                  bun add -g <strong>ircoder-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/ircoder")}>
                <code>
                  brew install <strong>anomalyco/tap/ircoder</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S ircoder")}>
                <code>
                  paru -S <strong>ircoder</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask ircoder-desktop")}>
                <code>
                  brew install --cask <strong>ircoder-desktop</strong>
                </code>
                <CopyStatus />
              </button>
