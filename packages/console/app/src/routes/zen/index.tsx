...
import compareVideo from "../../asset/lander/ircoder-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/ircoder-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="ircoder:auth" content={loggedin() ? "true" : "false"} />
