...
import { and, Database, eq, isNull, lt, or, sql } from "@ircoder/console-core/drizzle/index.js"
import { KeyTable } from "@ircoder/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@ircoder/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@ircoder/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@ircoder/console-core/util/date.js"
import { Identifier } from "@ircoder/console-core/identifier.js"
import { Billing } from "@ircoder/console-core/billing.js"
import { Actor } from "@ircoder/console-core/actor.js"
import { WorkspaceTable } from "@ircoder/console-core/schema/workspace.sql.js"
import { ZenData } from "@ircoder/console-core/model.js"
import { Subscription } from "@ircoder/console-core/subscription.js"
import { BlackData } from "@ircoder/console-core/black.js"
import { UserTable } from "@ircoder/console-core/schema/user.sql.js"
import { ModelTable } from "@ircoder/console-core/schema/model.sql.js"
import { ProviderTable } from "@ircoder/console-core/schema/provider.sql.js"
...
import { LiteData } from "@ircoder/console-core/lite.js"
import { Resource } from "@ircoder/console-resource"
...
export async function handler(
  ...
  try {
    ...
    const sessionId = input.request.headers.get("x-ircoder-session") ?? ""
    const requestId = input.request.headers.get("x-ircoder-request") ?? ""
    const ocClient = input.request.headers.get("x-ircoder-client") ?? ""
    ...
    const retriableRequest = async (retry: RetryOptions = { excludeProviders: [], retryCount: 0 }) => {
      ...
      const res = await fetchWith429Retry(reqUrl, {
        ...
        headers: (() => {
          ...
          headers.delete("x-ircoder-request")
          headers.delete("x-ircoder-session")
          headers.delete("x-ircoder-project")
          headers.delete("x-ircoder-client")
          return headers
        })(),
        body: reqBody,
      })
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    if (opts.modelList === "lite" && authInfo.billing.lite && authInfo.lite) {
      try {
        const consoleGoUrl = `https://ircoder.ai/workspace/${authInfo.workspaceID}/go`
    ...
    const billingUrl = `https://ircoder.ai/workspace/${authInfo.workspaceID}/billing`
    const membersUrl = `https://ircoder.ai/workspace/${authInfo.workspaceID}/members`
