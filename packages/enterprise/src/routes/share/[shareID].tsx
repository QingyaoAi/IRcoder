import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@ircoder/sdk/v2"
import { SessionTurn } from "@ircoder/ui/session-turn"
import { SessionReview } from "@ircoder/ui/session-review"
import { DataProvider } from "@ircoder/ui/context"
import { FileComponentProvider } from "@ircoder/ui/context/file"
import { WorkerPoolProvider } from "@ircoder/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@ircoder/ui/logo"
import { IconButton } from "@ircoder/ui/icon-button"
import { ProviderIcon } from "@ircoder/ui/provider-icon"
import { iife } from "@ircoder/core/util/iife"
import { Binary } from "@ircoder/core/util/binary"
import { NamedError } from "@ircoder/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@ircoder/ui/tabs"
import { MessageNav } from "@ircoder/ui/message-nav"
import { FileSSR } from "@ircoder/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@ircoder/ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/ircoder-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | IRcoder</Title>
              </Show>
              <Meta name="description" content="ircoder - The AI coding agent built for the terminal." />
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              <IconButton
                                as={"a"}
                                href="https://github.com/anomalyco/ircoder"
                                target="_blank"
                                icon="github"
                                variant="ghost"
                              />
