...
class Database extends Context.Service<Database, DatabaseShape>()("@ircoder/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@ircoder/example/UserStore") {
