...
import type { Event, GlobalEvent, IrcoderClient } from "@ircoder/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@ircoder/RunStreamTransport") {}
