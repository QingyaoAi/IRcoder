...
export const RootHttpApi = HttpApi.make("ircoder-root")
  .addHttpApi(ControlApi)
  .addHttpApi(GlobalApi)
  .middleware(SchemaErrorMiddleware)
  .middleware(Authorization)

export const InstanceHttpApi = HttpApi.make("ircoder-instance")
...
export const OpenCodeHttpApi = HttpApi.make("ircoder")
