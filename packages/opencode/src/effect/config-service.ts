 ...
 *   "@ircoder/ServerAuthConfig",
 *   {
 *     password: Config.string("IRCODER_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("IRCODER_SERVER_USERNAME").pipe(Config.withDefault("ircoder")),
 *   },
 * ) {}
 *
