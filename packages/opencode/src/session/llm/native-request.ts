import type { JsonSchema, LLMRequest, ProviderMetadata } from "@ircoder/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@ircoder/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @ircoder/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
