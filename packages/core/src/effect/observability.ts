...
import { ensureProcessMetadata } from "../util/ircoder-process"
...
export function resource(): { serviceName: string; serviceVersion: string; attributes: Record<string, string> } {
  ...
  return {
    ...
    attributes: {
      ...
      "ircoder.client": Flag.IRCODER_CLIENT,
      "ircoder.process_role": processMetadata.processRole,
      "ircoder.run_id": processMetadata.runID,
