...
// test/preload.ts pins IRCODER_MODELS_PATH to a fixture so other tests can
...
// bun process.
const ORIGINAL_MODELS_PATH = Flag.IRCODER_MODELS_PATH
const ORIGINAL_DISABLE_FETCH = Flag.IRCODER_DISABLE_MODELS_FETCH
beforeAll(() => {
  Flag.IRCODER_MODELS_PATH = undefined
  Flag.IRCODER_DISABLE_MODELS_FETCH = true
})
afterAll(() => {
  Flag.IRCODER_MODELS_PATH = ORIGINAL_MODELS_PATH
  Flag.IRCODER_DISABLE_MODELS_FETCH = ORIGINAL_DISABLE_FETCH
})
