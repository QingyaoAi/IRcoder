...
Schema-first LLM core for ircoder. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@ircoder-ai/llm"
import { OpenAI } from "@ircoder-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@ircoder-ai/llm/providers"
