export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de IRcoder",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de IRcoder. ¿Quieres instalarla y reiniciar?",
