...
const releaseId = process.env.IRCODER_RELEASE
if (!releaseId) throw new Error("IRCODER_RELEASE is required")

const version = process.env.IRCODER_VERSION
if (!version) throw new Error("IRCODER_VERSION is required")
...
const macxTarGz = "ircoder-desktop-mac-x64.app.tar.gz"
const macaTarGz = "ircoder-desktop-mac-arm64.app.tar.gz"
