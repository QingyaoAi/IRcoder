...
import { IconIrcoder } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "ircoder/session/message-v2"
import type { Message } from "ircoder/session/message"
import type { Session } from "ircoder/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.ircoder_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.ircoder_name}>
                    <IconIrcoder width={16} height={16} />
                  </div>
