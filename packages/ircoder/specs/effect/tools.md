...
Practical reference for the current tool-migration state in `packages/ircoder`.
...
Tool tests should use the existing Effect helpers in `packages/ircoder/test/lib/effect.ts`:
