...
How we write Effect code in `packages/ircoder`. The companion roadmap is
[`todo.md`](./todo.md).
...
export class Service extends Context.Service<Service, Interface>()("@ircoder/Foo") {}
...
Read ircoder runtime flags through
