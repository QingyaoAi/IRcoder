...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips ircoder-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-ircoder-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-ircoder-directory")).toBeNull()
      expect(result.get("x-ircoder-workspace")).toBeNull()
