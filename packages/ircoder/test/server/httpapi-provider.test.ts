...
describe("provider HttpApi", () => {
  it.instance.skip(
    ...
    Effect.gen(function* () {
      ...
      const response = yield* Effect.promise(() =>
        Promise.resolve(
          app().request("/api/provider/missing", { headers: { "x-ircoder-directory": instance.directory } }),
        ),
      )
  ...
  it.instance(
    ...
    Effect.gen(function* () {
      ...
      const headers = { "x-ircoder-directory": instance.directory, "content-type": "application/json" }
      const server = app()
  ...
  it.instance(
    ...
    Effect.gen(function* () {
      ...
      const response = yield* requestAuthorize({
        ...
        method: 0,
        inputs: { token: "nope" },
        headers: { "x-ircoder-directory": instance.directory, "content-type": "application/json" },
      })
  ...
  it.instance(
    ...
    Effect.gen(function* () {
      ...
      const headers = { "x-ircoder-directory": instance.directory }
