...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips ircoder-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-ircoder-directory"]).toBeUndefined()
      expect(forwarded["x-ircoder-workspace"]).toBeUndefined()
