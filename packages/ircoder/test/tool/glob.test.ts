  ...
  scout.instance(
    ...
    () =>
      Effect.gen(function* () {
        ...
        const cache = path.join(Global.Path.repos, "github.com", "ircoder-glob-reference", "repo")
        ...
        const remoteDir = path.join(remoteRoot, "ircoder-glob-reference")
      ...
      }),
    {
      config: {
        reference: {
          docs: "ircoder-glob-reference/repo",
        },
      },
    },
  )
