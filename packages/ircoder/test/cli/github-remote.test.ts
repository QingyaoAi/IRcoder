...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/ircoder.git")).toEqual({ owner: "sst", repo: "ircoder" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/ircoder")).toEqual({ owner: "sst", repo: "ircoder" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/ircoder.git")).toEqual({ owner: "sst", repo: "ircoder" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/ircoder")).toEqual({ owner: "sst", repo: "ircoder" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/ircoder.git")).toEqual({ owner: "sst", repo: "ircoder" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/ircoder")).toEqual({ owner: "sst", repo: "ircoder" })
})
