...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders IRCODER_CALLER", () => {
    process.env["IRCODER_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode IRCODER_CALLER", () => {
    process.env["IRCODER_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown IRCODER_CALLER", () => {
    process.env["IRCODER_CALLER"] = "unknown"
