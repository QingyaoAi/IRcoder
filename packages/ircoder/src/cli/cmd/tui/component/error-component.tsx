...
export function ErrorComponent(props: {
  ...
  const issueURL = new URL("https://github.com/anomalyco/ircoder/issues/new?template=bug-report.yml")
  ...
  issueURL.searchParams.set("ircoder-version", InstallationVersion)
