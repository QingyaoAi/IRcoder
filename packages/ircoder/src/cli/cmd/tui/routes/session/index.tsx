...
import { IRCODER_BASE_MODE, useBindings, useCommandShortcut, useIrcoderKeymap } from "../../keymap"
  ...
  createEffect(() => {
    ...
    return exit.message.set(
      [
        ...
        `  ${weak("Continue")}${UI.Style.TEXT_NORMAL_BOLD}ircoder -s ${session()?.id}${UI.Style.TEXT_NORMAL}`,
        ``,
      ].join("\n"),
    )
  })
