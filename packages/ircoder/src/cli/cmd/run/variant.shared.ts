...
//
// The saved variant persists across sessions in ~/.local/state/ircoder/model.json
...
class Service extends Context.Service<Service, VariantService>()("@ircoder/RunVariant") {}
