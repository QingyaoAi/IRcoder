...
<html>
  <head>
    <meta charset="utf-8" />
    <title>IRcoder - DigitalOcean Authorization</title>
    <style>
    ...
    <script>
      (async function() {
        ...
        try {
          ...
          msgEl.textContent = "You can close this window and return to IRcoder."
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              ...
              instructions:
                "Sign in to DigitalOcean in your browser. IRcoder will create a Model Access Key named ircoder-oauth-* and load your Inference Routers. Re-run /connect to refresh routers later.",
