...
import type { AssistantMessage as IRcoderAssistantMessage, Message } from "@ircoder/sdk/v2"
...
export type AssistantTokenCost = Pick<IRcoderAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<IRcoderAssistantMessage, "role"> &
  Partial<Pick<IRcoderAssistantMessage, "providerID" | "modelID">>
