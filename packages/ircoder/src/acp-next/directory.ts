...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@ircoder/ACPNextDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@ircoder/ACPNextDirectory") {}
