...
export class Service extends Context.Service<Service, Interface>()("@ircoder/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __IRCODER_PHOTON_WASM_PATH?: string }).__IRCODER_PHOTON_WASM_PATH =
