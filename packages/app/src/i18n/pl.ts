export const dict = {
  ...
  "dialog.provider.ircoder.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.ircoder.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.ircoderGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez IRcoder",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w IRcoder.",
  ...
  "provider.connect.ircoderZen.line1":
    "IRcoder Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.ircoderZen.visit.prefix": "Odwiedź ",
  "provider.connect.ircoderZen.visit.link": "ircoder.ai/zen",
  "provider.connect.ircoderZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w IRcoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w IRcoder.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w ircoder.json",
  ...
  "dialog.server.description": "Przełącz serwer IRcoder, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja IRcoder ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu IRcoder",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (ircoder.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "IRcoder zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla IRcoder",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd IRcoder na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy IRcoder ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw IRcoder.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania IRcoder",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji IRcoder.",
