export const dict = {
  ...
  "dialog.provider.ircoder.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.ircoder.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.ircoderGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af IRcoder",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i IRcoder.",
  ...
  "provider.connect.ircoderZen.line1":
    "IRcoder Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.ircoderZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.ircoderZen.visit.prefix": "Besøg ",
  "provider.connect.ircoderZen.visit.link": "ircoder.ai/zen",
  "provider.connect.ircoderZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i IRcoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i IRcoder.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i ircoder.json",
  ...
  "dialog.server.description": "Skift hvilken IRcoder-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af IRcoder ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til IRcoder-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (ircoder.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, IRcoder understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "IRcoder inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør IRcoder-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for IRcoder",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan IRcoder ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om IRcoder følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan IRcoder er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når IRcoder starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af IRcoder.",
