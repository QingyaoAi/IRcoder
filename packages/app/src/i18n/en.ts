export const dict = {
  ...
  "dialog.provider.ircoder.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.ircoder.tagline": "Reliable optimized models",
  "dialog.provider.ircoderGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by IRcoder",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in IRcoder.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.ircoderZen.line1":
    "IRcoder Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.ircoderZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.ircoderZen.visit.prefix": "Visit ",
  "provider.connect.ircoderZen.visit.link": "ircoder.ai/zen",
  "provider.connect.ircoderZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in IRcoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in IRcoder.",
  ...
  "dialog.plugins.empty": "Plugins configured in ircoder.json",
  ...
  "dialog.server.description": "Switch which IRcoder server this app connects to.",
  ...
  "toast.update.description": "A new version of IRcoder ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the IRcoder team",
  ...
  "error.chain.checkConfig": "Check your config (ircoder.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, IRcoder does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "IRcoder includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the IRcoder server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for IRcoder",
  ...
  "settings.general.row.appearance.description": "Customise how IRcoder looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether IRcoder follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how IRcoder is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when IRcoder launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of IRcoder.",
