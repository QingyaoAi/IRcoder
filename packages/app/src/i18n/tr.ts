...
export const dict = {
  ...
  "dialog.provider.ircoder.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.ircoder.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.ircoderGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "IRcoder tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve IRcoder'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.ircoderZen.line1":
    "IRcoder Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.ircoderZen.visit.prefix": "",
  "provider.connect.ircoderZen.visit.link": "ircoder.ai/zen",
  "provider.connect.ircoderZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve IRcoder'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak IRcoder'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler ircoder.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi IRcoder sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "IRcoder'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı IRcoder ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (ircoder.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: IRcoder henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "IRcoder ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "IRcoder Masaüstü",
  ...
  "settings.desktop.wsl.description": "IRcoder sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "IRcoder'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "IRcoder'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "IRcoder'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "IRcoder'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "IRcoder başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "IRcoder'un en son sürümünü kullanıyorsunuz.",
