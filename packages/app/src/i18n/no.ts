...
export const dict = {
  ...
  "dialog.provider.ircoder.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.ircoder.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.ircoderGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av IRcoder",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i IRcoder.",
  ...
  "provider.connect.ircoderZen.line1":
    "IRcoder Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.ircoderZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.ircoderZen.visit.prefix": "Besøk ",
  "provider.connect.ircoderZen.visit.link": "ircoder.ai/zen",
  "provider.connect.ircoderZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i IRcoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i IRcoder.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i ircoder.json",
  ...
  "dialog.server.description": "Bytt hvilken IRcoder-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av IRcoder ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til IRcoder-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (ircoder.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at IRcoder ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "IRcoder inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør IRcoder-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for IRcoder",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan IRcoder ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om IRcoder skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan IRcoder er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når IRcoder starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av IRcoder.",
