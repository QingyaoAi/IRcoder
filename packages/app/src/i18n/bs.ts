export const dict = {
  ...
  "dialog.provider.ircoder.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.ircoder.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.ircoderGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje IRcoder",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u IRcoder-u.",
  ...
  "provider.connect.ircoderZen.line1":
    "IRcoder Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.ircoderZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.ircoderZen.visit.prefix": "Posjeti ",
  "provider.connect.ircoderZen.visit.link": "ircoder.ai/zen",
  "provider.connect.ircoderZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u IRcoder-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u IRcoder-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u ircoder.json",
  ...
  "dialog.server.description": "Promijeni na koji se IRcoder server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija IRcoder-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku IRcoder timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (ircoder.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: IRcoder još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "IRcoder uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni IRcoder server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u IRcoder-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako IRcoder izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li IRcoder prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu IRcoder-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se IRcoder pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju IRcoder-a.",
