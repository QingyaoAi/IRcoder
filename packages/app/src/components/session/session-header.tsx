import { AppIcon } from "@ircoder/ui/app-icon"
...
import { Keybind } from "@ircoder/ui/keybind"
...
export function SessionHeader() {
  ...
  const isDesktopBeta = platform.platform === "desktop" && import.meta.env.VITE_IRCODER_CHANNEL === "beta"
  ...
  onMount(() => {
    setCenterMount(document.getElementById("ircoder-titlebar-center"))
    setRightMount(document.getElementById("ircoder-titlebar-right"))
  })
