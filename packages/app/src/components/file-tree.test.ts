...
beforeAll(async () => {
  ...
  mock.module("@ircoder/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@ircoder/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@ircoder/ui/icon", () => ({ Icon: () => null }))
  mock.module("@ircoder/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
