...
import { ResizeHandle } from "@ircoder/ui/resize-handle"
import { Button } from "@ircoder/ui/button"
import { IconButton } from "@ircoder/ui/icon-button"
import { Tooltip } from "@ircoder/ui/tooltip"
...
import { Session, type Message } from "@ircoder/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@ircoder/ui/toast"
...
import { retry } from "@ircoder/core/util/retry"
...
import { useTheme, type ColorScheme } from "@ircoder/ui/theme/context"
...
const USE_NEW_DESIGN = import.meta.env.VITE_IRCODER_CHANNEL !== "prod"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://ircoder.ai/desktop-feedback")}
      renderPanel={() =>
